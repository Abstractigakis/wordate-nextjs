    ...
    <div className="m-1 grid place-items-center">
      ...
      <div className="text-sm max-w-[290px]">
        <div className="m-2 grid place-items-center">
          Change one letter of a word. If the result is also a real word, and
          you have made a 'wordation'
        </div>
        <div className="m-2 grid place-items-center">
          <div className="flex">
            WORD
        ...
        <div className="m-2 grid place-items-center">
          Transform the starting word to the goal with as few wordations as
          possible
        </div>
